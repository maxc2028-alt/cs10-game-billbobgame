...
class GameView(arcade.View):
    ...
    def on_mouse_press(self, x: float, y: float, button: int, modifiers: int) -> None:
        ...
        level_one_hit = level_control_visible and 686 <= x <= 742 and 460 <= y <= 486
        level_two_hit = level_control_visible and 686 <= x <= 742 and 426 <= y <= 452
        level_three_hit = level_control_visible and 686 <= x <= 742 and 392 <= y <= 418
    ...
    def draw_hud(self) -> None:
        ...
        if self.screen == "playing" and not self.menu_open:
            ...
            if self.level_picker_open:
                arcade.draw_lrbt_rectangle_filled(680, 748, 354, 462, (14, 17, 24, 245))
                arcade.draw_lrbt_rectangle_outline(680, 748, 354, 462, (222, 222, 214), 2)
                arcade.draw_lrbt_rectangle_filled(686, 742, 460, 486, (40, 50, 65))
                arcade.draw_lrbt_rectangle_outline(686, 742, 460, 486, arcade.color.WHITE, 2)
                arcade.draw_text("Level 1", 714, 473, arcade.color.WHITE, 11, anchor_x="center")
                arcade.draw_lrbt_rectangle_filled(686, 742, 426, 452, (40, 50, 65))
                arcade.draw_lrbt_rectangle_outline(686, 742, 426, 452, arcade.color.WHITE, 2)
                arcade.draw_text("Level 2", 714, 439, arcade.color.WHITE, 11, anchor_x="center")
                arcade.draw_lrbt_rectangle_filled(686, 742, 392, 418, (40, 50, 65))
                arcade.draw_lrbt_rectangle_outline(686, 742, 392, 418, arcade.color.WHITE, 2)
                arcade.draw_text("Level 3", 714, 405, arcade.color.WHITE, 11, anchor_x="center")
